...
{
	W16 = (Wj_0.get_new_value() ^ (Wj_0.get_new_value().range(16, 0), Wj_0.get_new_value().range(31, 17)) ^(Wj_0.get_new_value().range(8, 0), Wj_0.get_new_value().range(31, 9)) ^(W3.get_new_value().range(24, 0), W3.get_new_value().range(31, 25)) ^W10.get_new_value());
}
