...
//void CompressExtend::assign_SS2_test()
//{	
//	var_SS2_test = SS2_test.read();
//	var_SS2_test.range(19,0) = SS1.read().range(19, 0);
//	SS2_test = var_SS2_test;
//	
//}
...
void CompressExtend::always_block()
{
	if (!rst.read())
	{
		...
		Tj  =  T0;
		var_WOUT_0 = WOUT_0;
		var_WOUT_0.range(255, 224) = IV_0;
		var_WOUT_0.range(223, 192) = IV_1;
		var_WOUT_0.range(191, 160) = IV_2;
		var_WOUT_0.range(159, 128) = IV_3;
		var_WOUT_0.range(127 , 96) = IV_4;
		var_WOUT_0.range(95 , 64 ) = IV_5;
		var_WOUT_0.range(63 , 32 ) = IV_6;
		var_WOUT_0.range(31  , 0 ) = IV_7;
		WOUT_0 = var_WOUT_0;
		// modified by xhhu
		W0  = 0;
		W1  = 0;
		...
		if (ctrl.read() == 0b01 || ctrl.read() == 0b10)
		{
			switch (Round.read())
			{
				...
				case 69: 
					...
					var_WOUT_0 = WOUT_0;
					A = var_WOUT_0.range(255, 224).to_uint();
					B = var_WOUT_0.range(223, 192).to_uint();
					C = var_WOUT_0.range(191, 160).to_uint();
					D = var_WOUT_0.range(159, 128).to_uint();
					E = var_WOUT_0.range(127, 96).to_uint();
					F = var_WOUT_0.range(95, 64).to_uint();
					G = var_WOUT_0.range(63, 32).to_uint();
					H = var_WOUT_0.range(31, 0).to_uint();
					WOUT_0 = var_WOUT_0;
